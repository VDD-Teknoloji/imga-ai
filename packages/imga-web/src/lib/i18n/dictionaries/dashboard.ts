...
export const dashboard: Bundle = {
  tr: {
    ...
    "dashboard.strategy.subtitle":
      "Analizleriniz üzerine SWOT ve OKR raporları üretin. Raporlar yapay zekâ ile oluşturulur ve PDF olarak indirilebilir.",
    "dashboard.strategy.meta.generatedAria": "Oluşturuldu: {time}",
    "dashboard.strategy.meta.reviewCount": "{n} yorum",
    "dashboard.strategy.banner.title": "Strateji raporu üretmek için bir LLM anahtarı gerekli.",
    ...
    "dashboard.strategy.swot.cardDesc":
      "Seçilen tarih aralığındaki analizler özetlenir, yapay zekâ SWOT (güçlü/zayıf yönler, fırsat/tehdit) ve stratejik öneri çıktısı üretir. Tarih boş bırakılırsa son 90 gün kullanılır.",
    ...
    "dashboard.strategy.noKeyHint":
      "Aktif LLM anahtarı yok — yukarıdaki uyarıdan eklemeniz gerekir.",
    "dashboard.strategy.swot.ready": "SWOT raporu hazır.",
    "dashboard.strategy.geminiUnavailable": "Yapay zekâ servisi şu an erişilemiyor: {detail}",
    ...
    "dashboard.strategy.swot.hasEvidence": "Kanıt içerir",
    ...
    "dashboard.strategy.okr.cardDesc":
      "OKR'lar mevcut bir SWOT raporundan türetilir — önce bir SWOT seçin, ardından yapay zekâ hedef-anahtar sonuç önerisi üretir.",
    ...
    "dashboard.strategy.okr.sourceSwotChip": "Kaynak SWOT: {date}",
  ...
  en: {
    ...
    "dashboard.strategy.subtitle":
      "Generate SWOT and OKR reports from your analyses. Reports are generated by AI and can be downloaded as PDF.",
    "dashboard.strategy.meta.generatedAria": "Generated: {time}",
    "dashboard.strategy.meta.reviewCount": "{n} reviews",
    "dashboard.strategy.banner.title": "An LLM key is required to generate strategy reports.",
    "dashboard.strategy.banner.desc":
    ...
    "dashboard.strategy.swot.cardDesc":
      "Analyses in the selected date range are summarized, and the AI produces a SWOT (strengths/weaknesses, opportunities/threats) plus strategic recommendations. If dates are left blank, the last 90 days are used.",
    ...
    "dashboard.strategy.noKeyHint":
      "No active LLM key — you need to add one from the notice above.",
    "dashboard.strategy.swot.ready": "SWOT report is ready.",
    "dashboard.strategy.geminiUnavailable": "The AI service is currently unavailable: {detail}",
    ...
    "dashboard.strategy.swot.hasEvidence": "Has evidence",
    ...
    "dashboard.strategy.okr.cardDesc":
      "OKRs are derived from an existing SWOT report — select a SWOT first, then the AI generates objective and key-result suggestions.",
    ...
    "dashboard.strategy.okr.sourceSwotChip": "Source SWOT: {date}",
