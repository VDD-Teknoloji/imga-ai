...
export const briefing: Bundle = {
  tr: {
    ...
    // --- Gemini anahtarı yok banner'ı ---
    "briefing.banner.title": "Yönetici özeti oluşturmak için Gemini API anahtarı gerekli.",
    ...
    "briefing.hero.modelAttribution": "Üreten model: {model}",
  ...
  en: {
    ...
    "briefing.banner.title": "A Gemini API key is required to generate executive summaries.",
    ...
    "briefing.hero.modelAttribution": "Generated by: {model}",
